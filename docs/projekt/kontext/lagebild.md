...
- F-652 · BUG · Keine Rolle der Workflow-Kette führt die Tests real aus — `ausfuehrung` hat kein Shell-Werkzeug, `code-reviewer` ist strukturell nur lesend; Code-Läufe blockieren deshalb oder melden „fertig", ohne dass irgendetwas verifiziert wurde.
