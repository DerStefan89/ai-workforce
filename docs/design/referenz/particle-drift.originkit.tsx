// REFERENZ — nicht ausführbar im Leitstand (kein React). Original von Stefan eingefügt, 18.09.2026.
// Portierung auf Vanilla-ES-Modul gemäß claude/247 (Auflagen: Reduced-Motion-/Sichtbarkeitsgatter,
// Farben aus :root, keine minWidth/minHeight, aria-hidden, WebGL-Rückfall, Frame-Budget messen).
// Lizenz des Registry-Codes ungeklärt (F-455) — vor Commit ins Repo klären.
//
