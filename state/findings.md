...
**F-643** · `HARNESS_IMPROVEMENT` · P1 · offen
...
Maßnahme: Offen — Isolation der `ausfuehrung`-Rolle (eigener Worktree/Branch je Workflow-Lauf, analog zur git-flow-Konvention für menschliche Sitzungen) ist eine Architekturentscheidung mit Tragweite (Workflow-Lebenszyklus, Merge-Zeitpunkt, Umgang mit Commits aus einem automatisierten Lauf) und WARTET auf Stefans Entscheidung — nicht Teil von `fix/f39-reallauf-befunde`, bewusst nicht mitgebaut.
