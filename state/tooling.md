...
| Codex CLI (`@openai/codex`, ChatGPT-Anmeldung) | zweiter Worker für lesende Rollen, E-M3-2 | 2026-09-09 (Spike S-M3-01) | Ja, 2026-09-09 — Spike S-M3-01 BESTANDEN, siehe `state/tp-m3-01-codex.md`. Windows-Sandbox: unelevated, `~/.codex/config.toml` (Entscheidung A1, 2026-09-10; Nachweis S-M3-01b ausstehend). Startziel für den Kern ist ausschließlich der native Vendor-Pfad `codex.exe`, nie ein npm-Shim (F-280). |
