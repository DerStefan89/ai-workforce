# 65 — Vertrag: harness-npm-run-allowlist-haertung (Option B)

Stand: 28.08.2026. Advisor-Pass-Entscheidung: Stefan verzichtet bewusst
(mechanischer Umbau, kein Designentscheid; Vertrag erzwingt eigene
Rot-/Grün-Kalibrierung) — Vermerk statt Advisor-Pass.

Grundlage: state/tp-nachtrag.md Abschnitt "TP-03 d, Messfall 1" und
"Abgeleiteter Befund" (Vertrag tp-03d-wirkungsgrenze-und-hash-baseline,
PR #8, gemergt 28.08.2026).
