...
async function main() {
  ...
  await page.goto(klickfolge.url)
  ...
  for (const schritt of klickfolge.schritte) {
    ...
    if (schritt.reload) await page.goto(klickfolge.url) // page.reload() hängt bei Hash-URLs (#/chat) in dieser Umgebung, goto() auf dieselbe URL ist gleichwertig
